...
int Frame_Base::getHeader() const
{
    return this->header;
}

void Frame_Base::setHeader(int header)
{
    this->header = header;
}
...
int Frame_Base::getAck_nack_number() const
{
    return this->ack_nack_number;
}

void Frame_Base::setAck_nack_number(int ack_nack_number)
{
...
int FrameDescriptor::findField(const char *fieldName) const
{
    ...
    if (strcmp(fieldName, "ack_nack_number") == 0) return baseIndex + 4;
